              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final transactionDate =
                      detailedTransactions.keys.toList()[index];
                  final transactionValues =
                      detailedTransactions.values.toList()[index];
                  return Column(
                    children: [
                      Padding(
                        ...
                        children: List.generate(
                          ...
                          (index) {
                            ...
                            return TransactionWidget(
                                icon: currentTransaction.icon,
                                title: currentTransaction.title,
                                description: currentTransaction.description,
                                amount: currentTransaction.amount,
                                date: currentTransaction.date,
                                textColor: currentTransaction.color ??
                                    appColors.textColor,
                                primaryColor: currentTransaction.color ??
                                    appColors.textColor);
                          },
                        ),
                      ),
