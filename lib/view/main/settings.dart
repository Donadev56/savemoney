            ...
            CustomOptionWidget(
                ...
                options: [
                  Option(
                      ...
                      color: colors.themeColor,
                      titleStyle: GoogleFonts.roboto(color: colors.themeColor),
                      tileColor: colors.themeColor.withOpacity(0.05)),
                  Option(
            ...
            CustomOptionWidget(
                ...
                options: [
                  ...
                  Option(
                      ...
                      tileColor: colors.redColor.withOpacity(0.05)),
                ],
                onTap: (index) {
                  log("Element clicked at index $index");
                }),
